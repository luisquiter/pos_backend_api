...
class Categoria (models.Model):
    ...
    categoria_nom = models.CharField(max_length=10,verbose_name='Nombre')
...
class PedidoPlato(models.Model):
    ...
    plato_id = models.ForeignKey(Plato,related_name='pedidosplatos',to_field='plato_id',db_column='pato_id',on_delete=models.RESTRICT)
