...
SECRET_KEY = 'django-insecure-=mq5$$34m*5*ib=iq5dk8e$o5getfbaupe&1sy4zf%7@3=$r73'
...
cloudinary.config( 
  cloud_name = "dgtxhlmtm", 
  api_key = "429421427242374", 
  api_secret = "26onJPLe6-5cx3dgfjtTiwKWZ7E" 
)
